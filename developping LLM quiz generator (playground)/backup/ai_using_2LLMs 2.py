...
## fetch info: juiste url ophalen als deze niet overeenkomt (in afzonderlijk bestand bouwen om te testen)
...
def generate_quiz_question(query: str, relevant_info: str, random_category: str) -> Response:
    ...
    role = f"""
    Je bent een farmacie docent. Gebruik uitsluitend de volgende informatie: {relevant_info}. Maak een praktijkgerichte quizvraag voor zeer ervaren apothekersassistenten (bachelorniveau).
    - Antwoordopties zijn uitdagend en lijken op elkaar, waardoor het moeilijk is het juiste antwoord te raden.
    - Het juiste antwoord staat letterlijk in de tekst, je verzint er niets bij. 
    - Foute antwoorden zijn aantoonbaar fout, dit is niet discutabel."""

    instructions = """ 
    - Introductie en uitleg zijn elk 3 tot 10 zinnen.
    - De introductie: 
        - beschrijft een realistische praktijksituatie van een patiënt, passend bij de vraag.
        - bevat alleen informatie die logisch is voor de situatie
        - mag het antwoord niet verklappen of suggereren.
        - Benoem alleen klachten, situaties of context die aansluiten bij het onderwerp van de vraag.
        - Controleer na het schrijven van de introductie of deze logische is en geen informatie omvast die het juiste antwoord of de antwoordopties verraad.
    - De uitleg: 
        - geeft relevante achtergrondinformatie (zoals farmacologische werking, klinische implicaties, uitzonderingen).
        - leg moeilijke termen uit, evt. tussenhaakjes.
    """                 
    try:
