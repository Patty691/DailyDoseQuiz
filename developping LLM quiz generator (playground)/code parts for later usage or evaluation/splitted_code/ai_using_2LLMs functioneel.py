...
from QuizChain import QuizGenerationChain, DebugCallback
...
#human in the loop.
#voorselectie van tekst maken d.m.v. vectorisatie. 

#laatste stap:
#schoon de code op. maak een readme (of update de bestaande readme). maak tests (unit en integratie)
#check of alle uitzonderingen en errors begrijpelijk zijn (ook uit welk stuk code ze vandaan komen) en of er geen dubbelingen zijn met de main_functie
